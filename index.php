...
<?php include("header.php"); ?>
            <div id="content" class="clearfix">
                ...
                <div class="main">
                <?php
                  $event1 = new EventItem("St. Patrick's Day Party","Tuesday March 17, 2015","5 p.m.", "Celebrate St. Patrick's day with lots of live music and half-price wings.","$10.00");
                  $event2 = new EventItem("Samy's Spring Fling!","Saturday April 18, 2015","8 p.m.", "Join us for to kick off the beginning of spring! This event will include 4 of Samy's infamous appetizers and one cocktail!","$40.00");
                  $result = array($event1, $event2); // results could come from database in the future
                ?>
